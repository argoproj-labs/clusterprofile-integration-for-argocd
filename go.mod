...
require (
	...
	github.com/argoproj/argo-cd/v3 v3.0.0-20260528161737-6d92e177b45f
...
require sigs.k8s.io/cluster-inventory-api v0.0.0-20251111185254-ed4b45f8d4a7
...
replace (
	github.com/argoproj/argo-cd/gitops-engine => github.com/argoproj/argo-cd/gitops-engine v0.0.0-20260528161737-6d92e177b45f
